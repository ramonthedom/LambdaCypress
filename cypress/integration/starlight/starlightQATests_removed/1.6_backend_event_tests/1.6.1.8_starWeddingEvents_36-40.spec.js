...
} from "../../starlightQATests/1_starlightTests/utilities.js";
import { userData } from "../../starlightQATests/1_starlightTests/common.js";
  ...
  it('should run tests for WEDDING events', function () {
    ...
    cy.contains('a', 'Events').should('exist').click().wait(1500).then(() => {
      ...
      cy.get('.evt-approved-cname').then($elements => {
        ...
        const END_INDEX = 40; // Set this to 5 more than START_INDEX (5, 10, 15, etc.)
